class ProjectsController < ApplicationController
  ...
  before_action :set_tenant, only: [:show, :edit, :update, :destroy, :new, :creat, :users, :add_user]
  ...
  def users
    ...
    @other_user = @tenant.users.whwere(tenant_id: @tenant.id, is_admin: false) - (@project_users + [current_user])
  end
  ...
  def add_user
    ...
    respond_to do |format|
      if @project_user.save
        ...
        format.html { redirect_to users_tenant_project_url(id: @project.id, tenant_id: @project.tenant_id),
          notice: "User was not added to project"}
      end
    end
